        ...
        {siteContent.whyChooseUs.items.map((item) => (
          <StaggerItem key={item.title}>
            <article className={cn(panelBase, panelHover, "group relative h-full overflow-hidden rounded-none p-6 sm:p-8")}>
              <div aria-hidden className="absolute left-0 top-0 h-1 w-full bg-[linear-gradient(90deg,transparent,rgba(16,185,129,0.6),transparent)] opacity-30 transition-opacity duration-500 group-hover:opacity-100" />
