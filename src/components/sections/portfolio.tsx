      ...
      <Stagger className="grid gap-4 lg:grid-cols-3">
        {siteContent.caseStudies.items.map((project, index) => {
          ...
          return (
            ...
            >
              <MouseGlow className="h-full rounded-none border border-[var(--panel-border)] bg-[var(--panel-bg)]" containerClassName="h-full flex flex-col justify-between">
                ...
                {isCard1 && (
                  <div className="flex h-full flex-col justify-between lg:flex-row">
                    {/* Left Column (Details) */}
                    <div className="flex flex-col p-6 sm:p-8 lg:w-[58%]">
                      ...
                      <div className="mt-6 space-y-4 rounded-none border border-[var(--border-color)] bg-[var(--text-100)]/[0.02] p-4 backdrop-blur-md">
                    ...
                    <div className="relative border-t border-[var(--border-color)] bg-[var(--text-100)]/[0.01] p-6 flex flex-col justify-center items-center lg:w-[42%] lg:border-t-0 lg:border-l">
                      <div className="w-full max-w-[210px] space-y-3 bg-[var(--bg-900)] border border-[var(--panel-border)] p-4 shadow-xl">
                        ...
                        <div className="h-28 bg-[var(--text-100)]/[0.02] border border-[var(--border-color)] flex items-center justify-center relative overflow-hidden">
                        ...
                        <div className="space-y-1.5">
                          <div className="h-3 w-3/4 bg-[var(--text-100)]/10" />
                          <div className="h-2.5 w-1/2 bg-[var(--text-100)]/[0.05]" />
                    ...
                    <div className="p-6 sm:p-8 flex-1 flex flex-col justify-between">
                      ...
                      <div className="mt-6 grid grid-cols-2 gap-2.5">
                        {project.results.slice(0, 2).map((res) => (
                          <div key={res} className="border border-[var(--border-color)] bg-[var(--text-100)]/[0.01] p-3 text-left">
                ...
                {isCard3 && (
                  <div className="flex h-full flex-col justify-between lg:flex-row">
                    {/* Left Column (Details) */}
                    <div className="flex flex-col p-6 sm:p-8 lg:w-[65%]">
                      <div className="mb-5 inline-flex w-fit items-center rounded-none border border-[var(--accent-primary)]/30 bg-[var(--accent-primary)]/10 px-3 py-1 text-[0.65rem] font-bold uppercase tracking-wider text-[var(--accent-primary)]">
                      ...
                      <div className="mt-6 grid gap-4 md:grid-cols-2">
                        <div className="rounded-none border border-[var(--border-color)] bg-[var(--text-100)]/[0.02] p-4 backdrop-blur-md">
                          <p className="text-sm text-[var(--text-muted)]">
                            <span className="block text-[0.7rem] font-bold uppercase tracking-wider text-[var(--text-soft)] mb-1">Challenge</span>
                            {project.challenge}
                          </p>
                    ...
                    <div className="relative border-t border-[var(--border-color)] bg-[var(--text-100)]/[0.01] p-6 flex flex-col justify-center items-center lg:w-[35%] lg:border-t-0 lg:border-l">
                      <div className="w-full max-w-[240px] space-y-4">
                        {project.results.map((res, i) => (
                          <div key={res} className="border border-[var(--panel-border)] bg-[var(--panel-bg)] p-4 shadow-xl flex items-center justify-between gap-3">
